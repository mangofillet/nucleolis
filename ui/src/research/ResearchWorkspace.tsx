...
const EXAMPLES = [
  { label: "Explore a mechanism", query: "What does SIRT1 activate?", icon: "model" },
  { label: "Test an intervention", query: "What happens to NLRP3 if I decrease SIRT1?", icon: "bolt" },
  { label: "Find target hypotheses", query: "Which targets could reduce CDKN2A?", icon: "target" },
];
...
export default function ResearchWorkspace() {
  const [query, setQuery] = useState("What happens to BDNF if I decrease MTOR?");
